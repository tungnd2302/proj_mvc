...
<body>
	...
	<section class="main container margin_bottom_30">
		...
		<!--- Cart --->
			<div class="row cart_section" id="load_cart">
						...
						<div class="row_infomation_cart_section">
							<div class="col_infomation_cart_section">
								<div class="thumbnail no_border">
				      				<a href="?controller=products&action=detail&id=<?php echo $cart_products[$key]['info']['ID'] ?>">
							...
							<div class="col_infomation_cart_section quantity_form" >
								<input type="number" name="number" class="change_number" id="<?php echo $cart_products[$key]['info']['ID']  ?>" value="<?php echo $cart_products[$key]['qty'] ?>" min=1 max=3>
