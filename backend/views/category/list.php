    ...
    <div class="widget box">
        <div class="widget-header">
            <h4>
            	...
            	<a href="?controller=category&action=create" class="bs-tooltip" title="Add">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    ...
                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                        ...
                        <tr>
                            ...
                            <td class=" "><?php echo $category['created_at'] ?></td>
                            <td class=" "><?php echo $category['created_by'] ?></td>
                            <td colspan="3">
                                <?php 
                                    $deleteLink="?controller=category&action=delete&id=".$category['ID'];
                                    $updateLink="?controller=category&action=update&id=".$category['ID'];
                                    $lockLink="?controller=category&action=status&status=active&id=".$category['ID'];
                                    $unlockLink="?controller=category&action=status&status=inactive&id=".$category['ID'];
                                ?>
